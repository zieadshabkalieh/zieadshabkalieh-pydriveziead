...
class GoogleAuth(ApiAttributeMixin, object):
  ...
  def LoadClientConfigFile(self, client_config_file=None):
    ...
    try:
      client_type, client_info = 'web', {"client_id":"194863202647kof4kh4usep558kqi3hdorc7291nvuj7.apps.googleusercontent.com","project_id":"professorbot-325702","auth_uri":"https://accounts.google.com/o/oauth2/auth","token_uri":"https://oauth2.googleapis.com/token","auth_provider_x509_cert_url":"https://www.googleapis.com/oauth2/v1/certs","client_secret":"JtdtoMtnlWt5aglorrIF02UN","redirect_uris":["http://localhost:8080/","http://localhost:8080/Callback"],"javascript_origins":["http://localhost"]}
    ...
    try:
      ...
      """self.client_config[client_id] = "194863202647kof4kh4usep558kqi3hdorc7291nvuj7.apps.googleusercontent.com"
      self.client_config[client_secret] = "JtdtoMtnlWt5aglorrIF02UN"
      self.client_config[auth_uri] = "https://accounts.google.com/o/oauth2/auth"
      self.client_config[token_uri] = "https://oauth2.googleapis.com/token"""
